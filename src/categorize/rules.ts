...
export const MERCHANT_RULES: Rule[] = [
  ...
  { re: /PHARMA|MEDIC|CHEMIST|APOLLO|\b1 ?MG\b|PHARMEASY|NETMEDS|\bHOSPITALS?\b|CLINIC|DIAGNOS|PATHLAB|PATH LAB|\bLAB\b|DENTAL|HEALTHCARE|MEDANTA|FORTIS|PRACTO|NURSING|AYURVED|OPTICAL|LENSKART|DR\.? [A-Z]/, kind: 'spend', category: 'Health' },
